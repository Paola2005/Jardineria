...
public class PersonTypeController: BaseController
    {
        ...
        {
            var entidades = await _unitOfWork.PTypes.GetAllAsync();
        ...
        {
            var entidad = await _unitOfWork.PTypes.GetByIdAsync(id);
            if(entidad == null)
            {
                return NotFound();
            }
        ...
        public async Task<ActionResult<PersonType>> Post(PersonTypeDto PersonTypeDto)
        {
            ...
            this._unitOfWork.PTypes.Add(entidad);
        ...
        public async Task<ActionResult<PersonTypeDto>> Put(int id, [FromBody] PersonTypeDto PersonTypeDto)
        {
            ...
            _unitOfWork.PTypes.Update(entidades);
            await _unitOfWork.SaveAsync();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.PTypes.Remove(entidad);
            await _unitOfWork.SaveAsync();
            return NoContent();
        }
    }
