...
public class OrderDetailController: BaseController
    {
        ...
        {
            var entidades = await _unitOfWork.Details.GetAllAsync();
        ...
        {
            var entidad = await _unitOfWork.Details.GetByIdAsync(id);
            if(entidad == null)
            {
                return NotFound();
            }
        ...
        public async Task<ActionResult<OrderDetail>> Post(OrderDetailDto OrderDetailDto)
        {
            ...
            this._unitOfWork.Details.Add(entidad);
        ...
        public async Task<ActionResult<OrderDetailDto>> Put(int id, [FromBody] OrderDetailDto OrderDetailDto)
        {
            ...
            _unitOfWork.Details.Update(entidades);
            await _unitOfWork.SaveAsync();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.Details.Remove(entidad);
            await _unitOfWork.SaveAsync();
            return NoContent();
        }
    }
