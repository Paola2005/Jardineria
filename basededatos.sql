...
CREATE TABLE `products` (
  `Id` varchar(255) NOT NULL,
  `Name` VARCHAR(1021) DEFAULT NULL,
  `ProductLine` int(11) NOT NULL,
  `Dimensions` VARCHAR(550) DEFAULT NULL,
...
INSERT INTO persons (FirstName, LastName1, LastName2, Email, PersonTypeId) VALUES
...
('marcos13','marcos@gardening.es','Pas1'),
('ruben15','rlopez@gardening.es','Pas1'),
('alberto21','asoria@gardening.es','Pas1'),
('maria451','msolis@gardening.es','Pas1'),
('felipe541','frosas@gardening.es','Pas1'),
('cortiz845','cortiz@gardening.es','Pas1'),
('csoria54','csoria@gardening.es','Pas1'),
('mlopez654','mlopez@gardening.es','Pas1'),
('lcampoamor494','lcampoamor@gardening.es','Pas1'),
('hrodriguez651','hrodriguez@gardening.es','Pas1'),
('manu54','manu@gardening.es','Pas1'),
('jmmart75','jmmart@hotmail.es','Pas1'),
('dpalma64','dpalma@gardening.es','Pas1'),
('opalma15','opalma@gardening.es','Pas1'),
('ffignon78','ffignon@gardening.com','Pas1'),
('lnarvaez6512','lnarvaez@gardening.com','Pas1'),
('lserra21','lserra@gardening.com','Pas1'),
('mbolton30','mbolton@gardening.com','Pas1'),
('wssanchez5','wssanchez@gardening.com','Pas1'),
('hwashington156','hwashington@gardening.com','Pas1'),
('mpaxton51','mpaxton@gardening.com','Pas1'),
('lpaxton156','lpaxton@gardening.com','Pas1'),
('nnishikori','nnishikori@gardening.com','Pas1'),
('nriko14','nriko@gardening.com','Pas1'),
('tnomura156','tnomura@gardening.com','Pas1'),
('ajohnson4145','ajohnson@gardening.com','Pas1'),
('lwestfalls561','lwestfalls@gardening.com','Pas1'),
('jwalton44','jwalton@gardening.com','Pas1'),
('kfalmer61','kfalmer@gardening.com','Pas1'),
('jbellinelli561','jbellinelli@gardening.com','Pas1'),
('mkishi615','mkishi@gardening.com','Pas1'),
('daniel.g651','daniel.g@gardening.com','Pas1'),
('anne45','anne.w@gardening.com','Pas1'),
('link416','link.f@gardening.com','Pas1'),
('akane165','akane.t@gardening.com','Pas1'),
('antoni15','antonio.l@gardening.com','Pas1'),
('jose5487','jose.b@gardening.com','Pas1'),
('paco454','paco.l@gardening.com','Pas1'),
('guillermo416','guillermo.r@gardening.com','Pas1'),
('david156','david.s@gardening.com','Pas1'),
('jos4514','jose.t@gardening.com','Pas1'),
('antonio456','antonio.l@gardening.com','Pas1'),
('pedro5156','pedro.c@gardening.com','Pas1'),
('juan562','juan.r@gardening.com','Pas1'),
('javier45145','javier.v@gardening.com','Pas1'),
('maria562','maria.r@gardening.com','Pas1'),
('beatriz516','beatriz.f@gardening.com','Pas1'),
('victoria5616','victoria.c@gardening.com','Pas1'),
('luis156','luis.m@gardening.com','Pas1'),
('mario45156','mario.s@gardening.com','Pas1'),
('cristian562','cristian.r@gardening.com','Pas1'),
('francisco5616','francisco.c@gardening.com','Pas1'),
('maria45156','maria.s@gardening.com','Pas1'),
('federico6512','federico.g@gardening.com','Pas1'),
('tony156','tony.m@gardening.com','Pas1'),
('eva45156','eva.s@gardening.com','Pas1'),
('matias45156','matias.s@gardening.com','Pas1'),
('benito155','benito.l@gardening.com','Pas1'),
('joseluis45156','joseluis.s@gardening.com','Pas1'),
('sara156','sara.m@gardening.com','Pas1'),
('luis54','luis.j@gardening.com','Pas1'),
('francois5145','francois.t@gardening.com','Pas1'),
('pierre541','pierre.d@gardening.com','Pas1'),
('jacob54','jacob.j@gardening.com','Pas1'),
